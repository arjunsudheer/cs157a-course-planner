...
public class CoursesController {
    ...
    public List<Course> searchCourses(
        ...
        if (nameOrProfessor != null && !nameOrProfessor.isEmpty()) {
            sqlBuilder.append(" AND (LOWER(CourseName) LIKE LOWER(?) OR LOWER(ProfessorName) LIKE LOWER(?))"); // adds
                                                                                                               // search
                                                                                                               // for
                                                                                                               // professor
                                                                                                               // and
    ...
    public ResponseEntity<?> getStudentPlan(@PathVariable Integer studentId) {
        ...
        String sql = "SELECT c.* FROM Courses c " +
                ...
                "WHERE pe.StudentID = ? ORDER BY c.CourseID"; // basically join courses and plannedenrollments tables
                                                              // and order by courseid
